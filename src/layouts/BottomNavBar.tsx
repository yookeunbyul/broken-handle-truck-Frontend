...
const BottomNavBar = () => {
    ...
    return (
        <div className="flex bg-black text-sm sticky bottom-0 z-[999999999]">
            <div
                className={[
            ...
            <div
                className={[
                    'flex flex-col flex-1 py-4 gap-1 items-center justify-center cursor-pointer',
                    isFocused('/category') ? 'text-primary stroke-primary' : 'text-white stroke-white',
                ].join(' ')}
                onClick={() => handleClick('/map')}
            >
            ...
            {isOwner ? (
                <div
                    className={[
                        'flex flex-col flex-1 py-4 gap-1 items-center justify-center cursor-pointer',
                        isFocused('/my-truck') ? 'text-primary stroke-primary' : 'text-white stroke-white',
                    ].join(' ')}
