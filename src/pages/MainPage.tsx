        ...
        <div className="bg-black h-full flex flex-col justify-center items-center">
            <div className="flex-[3] flex flex-col justify-center items-center gap-4">
                ...
                <p className="font-point text-white text-3xl">
                    핸들이 고장난 <strong className="text-primary font-point">푸드트럭</strong>
                </p>
            </div>
            <div className="flex-[2] flex flex-col justify-center gap-4 text-center max-w-screen-sm w-full px-8 sm:px-20">
                <button
                    className="bg-kakao text-kakao-black text-base lg:text-lg mx-auto px-10 sm:px-24 py-5 rounded-lg font-bold relative w-full"
                ...
                <div
                    className="bg-primary text-base lg:text-lg mx-auto px-10 py-5 text-white rounded-lg font-bold sm:px-24 cursor-pointer w-full"
