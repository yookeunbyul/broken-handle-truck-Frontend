    ...
    const handleUpdateMapCenter = useCallback(() => {
        if (mapRef.current && data?.store) {
            mapRef.current.setCenter(
                new window.kakao.maps.LatLng(data.store.coordinates[1], data.store.coordinates[0])
            );
        }
    }, [data?.store]);
            ...
            {data?.store ? (
                <div className="relative h-full flex flex-col">
                    <div className="bg-review h-64 rounded-b-3xl relative">
                        ...
                        <div className="flex justify-end absolute bottom-3 z-10 w-[calc(100%-50px)] sm:w-[calc(100%-250px)] left-1/2 -translate-x-1/2">
                            <Toggle text={{ on: '영업중', off: '영업 종료' }} />
                        </div>
                    </div>
                    <div className="w-[calc(100%-50px)] sm:w-[calc(100%-250px)] mx-auto mt-10 mb-5">
                    ...
                    <div className="flex w-[calc(100%-50px)] sm:w-[calc(100%-250px)] mx-auto items-center gap-x-1 pt-11 mb-3">
                    ...
                    <div className="w-[calc(100%-50px)] sm:w-[calc(100%-250px)] mx-auto pb-5 flex-1">
